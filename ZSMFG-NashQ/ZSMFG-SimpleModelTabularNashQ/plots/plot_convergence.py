...
Q_1_visited_times = npzfile["Q_1_visited"]
Q_2_visited_times = npzfile["Q_2_visited"]
...
if __name__ == "__main__":
    #print(Q_1.shape)
    print(np.average(Q_1_visited_times))
    print(np.average(Q_2_visited_times))
    ...
    # plt.legend()
    # plt.title("plot of player1's convergence result")
    # plt.savefig("ZSMFG-NashQ/ZSMFG-SimpleModelTabularNashQ/plots/convergenceQ1_2actions_zeros_MC_5000iters_L2.pdf")